...
using MultilEcommer.Areas.Identity.Models.AccountViewModels;
using MultilEcommer.Areas.Identity.Models.ManageViewModels;
using MultilEcommer.Areas.Identity.Models.RoleViewModels;
using MultilEcommer.Areas.Identity.Models.UserViewModels;
using MultilEcommer.Data;
using MultilEcommer.ExtendMethods;
...
namespace MultilEcommer.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, ApplicationDbContext context, UserManager<IdentityUser> userManager)
        {
            _logger = logger;
